...
=================================================================================================================
Script Purpose:
  This stored procedure performs the ETL (Extract, Transform, Load) process to populate the 'silver' schema tables from the 'bronze' tables.
...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO silver.crm_cust_info(
			...
			cst_key,
			cst_firstname,
			cst_lastname,cst_material_status,
			cst_gndr,
			cst_create_date)
		SELECT
		cst_id,
	...
	BEGIN CATCH
		PRINT '==============================================';
		PRINT 'ERROR OCCURED DURING LOADIND SILVER LAYER';
